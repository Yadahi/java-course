...
public class Warrior extends PlayerCharacter {
    ...
    // Constructor that sets warrior stats, weapon, and image
    public Warrior(String name, int baseAttack, int defense, int agility, int hitPoints, Weapon weapon) {
        super(name, baseAttack, defense, agility, hitPoints, weapon);
        setCharacterPic(new ImageIcon(this.getClass().getResource("/Images/fighter.png")));
    }

    // Return formatted string of warrior stats for the battle screen
    @Override
